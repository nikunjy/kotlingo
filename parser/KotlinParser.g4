...
typeAlias
    : modifiers? TYPE_ALIAS NL* simpleIdentifier (NL* typeParameters)? NL* ASSIGNMENT NL* dataType
    ;
...
classParameter
    : modifiers? (VAL | VAR)? NL* simpleIdentifier COLON NL* dataType (NL* ASSIGNMENT NL* expression)?
    ;
...
typeParameter
    : typeParameterModifiers? NL* simpleIdentifier (NL* COLON NL* dataType)?
    ;
...
typeConstraint
    : annotation* simpleIdentifier NL* COLON NL* dataType
    ;
...
variableDeclaration
    : annotation* NL* simpleIdentifier (NL* COLON NL* dataType)?
    ;
...
getter
    : modifiers? GET
      (NL* LPAREN NL* RPAREN (NL* COLON NL* dataType)? NL* functionBody)?
    ;

setter
    : modifiers? SET
      (NL* LPAREN NL* functionValueParameterWithOptionalType (NL* COMMA)? NL* RPAREN (NL* COLON NL* dataType)? NL* functionBody)?
    ;
...
parameterWithOptionalType
    : simpleIdentifier NL* (COLON NL* dataType)?
    ;
...
typeProjection
    : typeProjectionModifiers? dataType
    | MULT
    ;
...
functionType
    : (receiverType NL* DOT NL*)? functionTypeParameters NL* ARROW NL* dataType
    ;

functionTypeParameters
    : LPAREN NL* (parameter | dataType)? (NL* COMMA NL* (parameter | dataType))* (NL* COMMA)? NL* RPAREN
    ;

parenthesizedType
    : LPAREN NL* dataType NL* RPAREN
    ;
...
infixOperation
    : elvisExpression (inOperator NL* elvisExpression | isOperator NL* dataType)*
    ;
...
asExpression
    : prefixUnaryExpression (NL* asOperator NL* dataType)*
    ;
...
lambdaParameter
    : variableDeclaration
    | multiVariableDeclaration (NL* COLON NL* dataType)?
    ;
...
superExpression
    : SUPER (LANGLE NL* dataType NL* RANGLE)? (AT_NO_WS simpleIdentifier)?
    | SUPER_AT
    ;
...
catchBlock
    : CATCH NL* LPAREN annotation* simpleIdentifier COLON dataType (NL* COMMA)? RPAREN NL* block
    ;
